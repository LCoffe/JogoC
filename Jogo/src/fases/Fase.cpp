...
namespace Fase {
	...
	Fase::Fase(IDs::IDs ID_Fase) : Ente(ID_Fase), pGS(new Gerenciador::GerenciadorSalvar()), doisJogadores(false), pontuacao(0), fundo(nullptr), mapa(nullptr), pObsFase(new Observado::Observador::ObservadorFase(this)) {
