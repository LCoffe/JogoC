...
namespace Fase {
	class Fase : public Ente {
		...
		protected:
			...
			void criaPlataforma(const sf::Vector2f pos, const sf::Vector2f tam, const IDs::IDs ID, bool arrastado, bool colisaoParede); //Metodo usado para carregar as plataformas
			void criaLimite();
		public:
